...
import org.example.app.controller.PostsByLimitController;
...
public class AppModel {
    ...
    public void readTenPosts() {
        PostModel model = new PostModel();
        PostsView view = new PostsView();
        PostsByLimitController controller = new PostsByLimitController(model, view);
        controller.getTenPosts();
    }
}
